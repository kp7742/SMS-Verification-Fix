...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/whatsapp/registration/EULA;->k:Lcom/whatsapp/registration/bj;
...
.method final k()V
    ...
    invoke-static {p0}, Lcom/whatsapp/aur;->h(Landroid/content/Context;)V

    iget-object v0, p0, Lcom/whatsapp/registration/EULA;->k:Lcom/whatsapp/registration/bj;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v2, p0, Lcom/whatsapp/sz;->ab:Z

    invoke-super {p0, p1}, Lcom/whatsapp/sz;->onCreate(Landroid/os/Bundle;)V

    invoke-static {}, Lcom/whatsapp/sv;->a()Z

    move-result v0

    if-eqz v0, :cond_0

    invoke-static {p0}, Lcom/whatsapp/sv;->a(Landroid/app/Activity;)V
    ...
    :cond_2
    :try_start_0
    sget-object v0, Lcom/whatsapp/App;->s:Lcom/whatsapp/util/bt;

    const-wide/16 v4, 0xa

    sget-object v1, Ljava/util/concurrent/TimeUnit;->SECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v0, v4, v5, v1}, Lcom/whatsapp/util/bt;->a(JLjava/util/concurrent/TimeUnit;)Lcom/whatsapp/util/bt$b;
    :try_end_0
    ...
    iget-object v0, v0, Lcom/whatsapp/util/bt$b;->a:Ljava/util/Set;
    ...
    invoke-static {p0, v8}, Lcom/whatsapp/tl;->a(Landroid/app/Activity;I)V
...
.method public onCreateDialog(I)Landroid/app/Dialog;
    ...
    invoke-virtual {v0}, Lcom/whatsapp/util/bt;->a()Lcom/whatsapp/util/bt$b;
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    ...
    iget-object v1, v0, Lcom/whatsapp/util/bt$b;->a:Ljava/util/Set;
    ...
    invoke-virtual {v2, v0}, Landroid/support/v7/app/l$a;->b(Ljava/lang/CharSequence;)Landroid/support/v7/app/l$a;
    ...
    check-cast v0, Lcom/whatsapp/util/bt$a;
    ...
    iget-object v0, v0, Lcom/whatsapp/util/bt$a;->a:Ljava/lang/CharSequence;
    ...
    invoke-virtual {v0, v3, v1}, Landroid/support/v7/app/l$a;->a(ILandroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/l$a;
    ...
    invoke-virtual {v0, v2, v1}, Landroid/support/v7/app/l$a;->b(ILandroid/content/DialogInterface$OnClickListener;)Landroid/support/v7/app/l$a;
